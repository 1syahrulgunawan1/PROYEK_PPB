                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(GPS.this, REQUEST_CHECK_SETTINGS);
    ...
    public void startLocationButtonClick() {
        ...
        Dexter.withActivity(this)
                ...
                .withListener(new PermissionListener() {
                    ...
                    private void onPermissionRationaleShouldBeShown(PermissionRequest permission, PermissionToken token) {
